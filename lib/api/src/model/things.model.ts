...
export class Feature extends EntityWithId {
  ...
  public constructor(private readonly _id: string,
    ...
    private readonly _desiredProperties?: Record<string, any>) {
    super();
  }
  ...
  public static fromObject(o: any, key: string): Feature {
    ...
    // @ts-ignore
    return new Feature(key, o['definition'], o['properties'], o['desiredProperties']);
  }
  ...
  get desiredProperties(): Record<string, any> | undefined {
    return this._desiredProperties;
  }
}
