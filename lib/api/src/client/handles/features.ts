...
export class DefaultFeaturesHandle implements FeaturesHandle {
  ...
  public getDesiredProperties(featureId: string, options?: FieldsOptions): Promise<Object> {
    return this.requestFactory.fetchJsonRequest({
      verb: 'GET',
      parser: o => o,
      id: this.thingId,
  ...
  public getDesiredProperty(featureId: string, propertyPath: string, options?: MatchOptions): Promise<any> {
    return this.requestFactory.fetchJsonRequest({
      verb: 'GET',
      parser: o => o,
      id: this.thingId,
      path: `features/${featureId}/desiredProperties/${propertyPath}`,
      requestOptions: options
    });
  }
  ...
  public deleteDesiredProperties(featureId: string, options?: MatchOptions): Promise<GenericResponse> {
    return this.requestFactory.fetchRequest({
      verb: 'DELETE',
      id: this.thingId,
      path: `features/${featureId}/desiredProperties`,
  ...
  public deleteDesiredProperty(featureId: string, propertyPath: string, options?: MatchOptions): Promise<GenericResponse> {
    return this.requestFactory.fetchRequest({
      verb: 'DELETE',
      id: this.thingId,
      path: `features/${featureId}/desiredProperties/${propertyPath}`,
  ...
  public putDesiredProperties(featureId: string, desiredProperties: object, options?: MatchOptions): Promise<PutResponse<Object>> {
    return this.requestFactory.fetchPutRequest({
      verb: 'PUT',
      parser: o => o,
      id: this.thingId,
  ...
  public putDesiredProperty(featureId: string, propertyPath: string,
                      desiredProperty: any, options?: MatchOptions): Promise<PutResponse<any>> {
    return this.requestFactory.fetchPutRequest({
      verb: 'PUT',
      parser: o => o,
      id: this.thingId,
