...
export interface FeaturesHandle {
  ...
  /**
   * Gets the desired properties of the specified Feature
   *
   * @param featureId - The ID of the Feature.
   * @param options - Options to use for the request.
   * @returns A Promise for the desired properties
   */
  getDesiredProperties(featureId: string, options?: FieldsOptions): Promise<Object>;

   /**
    * Gets a desired property of the specified Feature.
    *
    * @param featureId - The ID of the Feature.
    * @param propertyPath - The path to the property.
    * @param options - Options to use for the request.
    * @returns A Promise for the desired property
    */
  getDesiredProperty(featureId: string, propertyPath: string, options?: FieldsOptions): Promise<any>;
  ...
  /**
   * Adds or updates the desired properties of the specified Feature.
   *
   * @param featureId - The ID of the Feature.
   * @param properties - The new desired properties.
   * @param options - Options to use for the request.
   * @returns A Promise for the response
   */
  putDesiredProperties(featureId: string, desiredProperties: object, options?: MatchOptions): Promise<PutResponse<Object>>;

   /**
    * Adds or updates a desired property of the specified Feature.
    *
    * @param featureId - The ID of the Feature.
    * @param propertyPath - The path to the property.
    * @param desiredProperty - The new desired property.
    * @param options - Options to use for the request.
    * @returns A Promise for a response containing the new desired property if provided by the response
    */
  putDesiredProperty(featureId: string, propertyPath: string, desiredProperty: any, options?: MatchOptions): Promise<PutResponse<any>>;
  ...
  /**
   * Deletes the desired properties of a Feature.
   *
   * @param featureId - The ID of the Feature.
   * @param options - Options to use for the request.
   * @returns A Promise for the response
   */
  deleteDesiredProperties(featureId: string, options?: MatchOptions): Promise<GenericResponse>;

  /**
   * Deletes a desired property of a Feature.
   *
   * @param featureId - The ID of the Feature.
   * @param propertyPath - The path to the property.
   * @param options - Options to use for the request.
   * @returns A Promise for the response
   */
  deleteDesiredProperty(featureId: string, propertyPath: string, options?: MatchOptions): Promise<GenericResponse>;
}
